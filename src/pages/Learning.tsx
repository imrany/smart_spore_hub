...
import { Course, Profile, Session } from "@/types";
...
const Learning = () => {
  ...
  const loadCourses = async () => {
    const { data, error } = await fetchData("/api/v1/courses", {
      method: "GET",
      headers: {
  ...
  const mockCourses: Course[] = [
    {
      ...
      description:
        "Learn the basics of growing oyster and button mushrooms at home or on your farm.",
      duration: "2 hours",
      level: "beginner",
    },
    {
      ...
      description:
        "Master advanced methods for maximizing yield and quality of your mushroom harvest.",
      duration: "4 hours",
      level: "advanced",
    },
    {
      ...
      description:
        "Learn how to market, price, and sell your mushroom products effectively.",
      duration: "3 hours",
      level: "intermediate",
    },
    {
      ...
      description:
        "Identify and manage common mushroom cultivation problems and diseases.",
      duration: "2.5 hours",
      level: "intermediate",
    },
  ];
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Access comprehensive courses to improve your mushroom cultivation
